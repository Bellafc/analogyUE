from src.lm_polygraph.estimators import Eccentricity
...
## put your openai api key inside the first ''
## change the model you would like to use inside the second ''
